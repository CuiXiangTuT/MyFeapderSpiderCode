...
from items.temporary_search_youtube_info_batch_data_item import *
import re
import json
...
class GetYoutubeInfoViews(feapder.BatchSpider):
    def add_task(self):
        ...
        SET {} = 0
        WHERE {} != 1
        """.format(self._task_table,self._task_state,self._task_state)
    ...
    def parse(self, request, response):
        ...
        youtube_info = TemporarySearchYoutubeInfoBatchDataItem()
        try:
            try:
