# -*- coding: utf-8 -*-
"""
Created on 2023-08-25 12:01:09
---------
@summary:
---------
@author: QiuQiuRen
...
class YoutubeMusicAboutAlbumSinglePlaylistGetInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        playlist_list = browser.find_elements_by_xpath('//ytmusic-two-row-item-renderer[@aspect-ratio="MUSIC_TWO_ROW_ITEM_THUMBNAIL_ASPECT_RATIO_SQUARE"]/a')
    ...
    def parse_redirect(self,request,response):
        ...
        youtube_music_channel_id_playlist_batch_data_item['youtube_music_channel_id'] = request.task_youtube_music_channel_id
        youtube_music_channel_id_playlist_batch_data_item['youtube_music_album_single_playlist_url'] = request.task_youtube_music_album_single_playlist_url
        youtube_music_channel_id_playlist_batch_data_item['youtube_music_album_single_url_pre_redirect'] = request.pre_redirect_url
...
if __name__ == "__main__":
    spider = YoutubeMusicAboutAlbumSinglePlaylistGetInfoSpider(
    ...
    parser = ArgumentParser(description="YoutubeMusicAboutAlbumSinglePlaylistGetInfoSpider爬虫")
    ...
    # 通过命令行启动
    # python youtube_music_about_album_single_playlist_get_info_spider.py --start_master  # 添加任务
    # python youtube_music_about_album_single_playlist_get_info_spider.py --start_worker  # 启动爬虫
