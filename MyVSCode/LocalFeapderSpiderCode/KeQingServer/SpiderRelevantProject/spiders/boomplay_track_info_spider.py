...
class BoomplayTrackInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if response.xpath('//div[@class="noData"]/div[@class="text"]'):
            ...
            if artist_info_batch_task_item:
                yield self.add_new_task('boomplay_artist_info_batch_task',artist_info_batch_task_item.to_dict)
            if album_info_batch_task_item:
                yield self.add_new_task('boomplay_album_info_batch_task',album_info_batch_task_item.to_dict)
