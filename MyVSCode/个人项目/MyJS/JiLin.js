...
window.document = {
    "referrer": "http://www.ccgp-jilin.gov.cn/"
};
...
function dd(exponent, modulus, keyId) {
    var _0x5512b1 = '';
    var _0x5608a2 = new Date()['getTime']();
    var _0x543b2f = exponent;
    var _0x5a033f = modulus;
    var _0x1ced60 = keyId;

    setMaxDigits(130);
    
    var _0xaed189 = new RSAKeyPair(_0x543b2f,'',_0x5a033f);

    _0x5512b1 = encryptedString(_0xaed189, encodeURIComponent(_0x1ced60));
