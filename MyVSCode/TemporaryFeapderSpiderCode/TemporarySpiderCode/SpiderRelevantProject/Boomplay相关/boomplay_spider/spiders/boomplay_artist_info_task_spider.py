                    ...
                    if track_amount == 0:
                        ...
                        if track_amount>100:
                            ...
                            for page_no in range(2,page_num):
                                url = "https://www.boomplay.com/artistsSongMore_part/{}?songTotal={}&page={}".format(request.task_boomplay_artist_id,track_amount,page_no)
                                headers={
                                    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36'
                                }
                                yield feapder.Request(url=url,headers=headers,callback=self.parse_track_page,task_boomplay_artist_id=request.task_boomplay_artist_id)
                except:
                ...
                try:
                    ...
                    if int(album_amount) > 100:
                        ...
                        for page_no in range(2,page_amount):
                            album_page_url = "https://www.boomplay.com/artists_part/albums/{}?page={}".format(request.task_boomplay_artist_id,page_no)
                            headers={
                                'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36'
                            }
                            yield feapder.Request(url=album_page_url,headers=headers,callback=self.parse_album_page,task_boomplay_artist_id=request.task_boomplay_artist_id)
                except:
