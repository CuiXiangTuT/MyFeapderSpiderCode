...
# 如需使用，则需要更改参数
# 入库：北京临时数据库
# BJ_VIRTUAL_SERVER_MYSQL_IP = "122.115.36.92"
# BJ_VIRTUAL_SERVER_MYSQL_PORT = 3306
# BJ_VIRTUAL_SERVER_MYSQL_DB = "temporary_data"
# BJ_VIRTUAL_SERVER_MYSQL_USER_NAME = "crawler"
# BJ_VIRTUAL_SERVER_MYSQL_USER_PASS = "crawler.mysql"

# # 如需使用，则需要更改参数
# # 入库：香港临时数据库
# HK_VIRTUAL_SERVER_MYSQL_IP = "8.218.99.123"
# HK_VIRTUAL_SERVER_MYSQL_PORT = 3306
# HK_VIRTUAL_SERVER_MYSQL_DB = "temporary_data"
# HK_VIRTUAL_SERVER_MYSQL_USER_NAME = "crawler"
# HK_VIRTUAL_SERVER_MYSQL_USER_PASS = "crawler.mysql"
...
REDISDB_IP_PORTS = "8.218.99.123:6379"
REDISDB_USER_PASS = "GMG.redis"
REDISDB_DB = 2
# # 适用于redis哨兵模式
