...
def local_redis_to_excel(redis_key,excel_name):
    if os.path.isfile(excel_name):
        ...
        print("文件已存在，删除文件成功")
    rd = redis.Redis(host='192.168.10.136',port=6379,db=10,password='123456',decode_responses=True)
...
if __name__=='__main__':
    redis_key = 'youtube_view_spider:href:searchyoutubeinfo202307300502'
