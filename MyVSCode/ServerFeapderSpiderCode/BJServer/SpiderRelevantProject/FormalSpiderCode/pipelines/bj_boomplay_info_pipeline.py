...
class BJBoomplayInfoPipeline(BasePipeline):

    def __init__(self) -> None:
        # 链接数据库
        self._db = MysqlDB(ip=BJ_VIRTUAL_SERVER_MYSQL_IP,
                           port=BJ_VIRTUAL_SERVER_MYSQL_PORT,
                           user_name=BJ_VIRTUAL_SERVER_MYSQL_USER_NAME,
                           user_pass=BJ_VIRTUAL_SERVER_MYSQL_USER_PASS,
                           db=BJ_VIRTUAL_SERVER_MYSQL_DB)
