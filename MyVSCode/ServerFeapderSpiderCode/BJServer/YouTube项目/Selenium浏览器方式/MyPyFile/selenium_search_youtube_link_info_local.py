...
crawl_date = 'searchyoutubeinfo20231114' # 更改
sheet_name = 'searchyoutubeinfo20231114'

redisClient = redis.StrictRedis('192.168.10.133', 6379, 10,'123456')
...
def search_view_by_name(driver, item):
    ...
    # # 最佳匹配结果
    # 歌曲标题及链接
    track_info = driver.find_element(By.XPATH,'.//div[@class="metadata-container style-scope ytmusic-card-shelf-renderer"]/yt-formatted-string/a')
