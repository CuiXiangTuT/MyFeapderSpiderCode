...
# ITEM_PIPELINES = [
    ...
    # "pipelines.bj_temporary_data_youtube_info_pipeline.BjTemporaryDataYoutubeInfoPipeline",
    # "pipelines.hk_temporary_data_youtube_info_pipeline.HkTemporaryDataYoutubeInfoPipeline",
# ]
