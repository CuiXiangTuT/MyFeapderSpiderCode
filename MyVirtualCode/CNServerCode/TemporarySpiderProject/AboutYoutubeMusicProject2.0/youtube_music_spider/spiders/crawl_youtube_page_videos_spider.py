# -*- coding: utf-8 -*-
"""
Created on 2023-12-22 15:30:08
---------
@summary:
---------
@author: QiuQiuRen
...
class CrawlPageVideosSpider(feapder.BatchSpider):
    def init_task(self):
        pass
    ...
    def parse(self, request, response):
        ...
        title_detail_info = browser.find_element(By.XPATH,
                                                 '//div[@class="content-container style-scope ytmusic-detail-header-renderer"]//h2[@class="style-scope ytmusic-detail-header-renderer"]/yt-formatted-string[@class="title style-scope ytmusic-detail-header-renderer"]')
        ...
        d["img_url"] = browser.find_element(By.XPATH,
                                            './/ytmusic-cropped-square-thumbnail-renderer[@class="style-scope ytmusic-detail-header-renderer"]/yt-img-shadow/img').get_attribute(
            'src')

        subtitle_detail_info_1 = browser.find_elements(By.XPATH,
                                                       './/yt-formatted-string[@class="second-subtitle style-scope ytmusic-detail-header-renderer"]')
        ...
        playlist_list = browser.find_elements(By.XPATH,
                                              '//ytmusic-responsive-list-item-renderer[@class="style-scope ytmusic-playlist-shelf-renderer"]')
        for i in playlist_list:
            ...
            video_detail_info = i.find_element(By.XPATH,
                                               './/yt-formatted-string[@class="title style-scope ytmusic-responsive-list-item-renderer complex-string"]/a')
            # 歌曲名
            ...
            youtube_music_artist_plate_data_item['youtube_music_video_url_split_playlist_url'] = "https://music.youtube.com/playlist?list=" + str(
                youtube_music_artist_plate_data_item['youtube_music_video_url_split_playlist_id'])

            column_detail_info = i.find_elements(By.XPATH,
                                                 './/yt-formatted-string[@class="flex-column style-scope ytmusic-responsive-list-item-renderer complex-string"]')

            if len(column_detail_info) == 1:
                ...
                if "channel" in str(href):
                    ...
                    youtube_music_artist_plate_data_item["youtube_music_video_artist_name"] = i.find_element(By.XPATH,
                                                                             './/yt-formatted-string[@class="flex-column style-scope ytmusic-responsive-list-item-renderer"][1]').text
                    youtube_music_artist_plate_data_item["youtube_music_video_artist_channel_id"] = None

            elif len(column_detail_info) == 0:
                detail_info = i.find_elements(By.XPATH,
            ...
            duration_info = i.find_element(By.XPATH,
                                           './/div[@class="fixed-columns style-scope ytmusic-responsive-list-item-renderer"]/yt-formatted-string[@class="fixed-column MUSIC_RESPONSIVE_LIST_ITEM_COLUMN_DISPLAY_PRIORITY_HIGH style-scope ytmusic-responsive-list-item-renderer style-scope ytmusic-responsive-list-item-renderer"]')
            # 播放时长
            ...
            youtube_music_video_task_item['youtube_music_channel_id'] = youtube_music_artist_plate_data_item[
                'youtube_music_channel_id']
            youtube_music_video_task_item['youtube_music_video_id'] = youtube_music_artist_plate_data_item[
                'youtube_music_video_id']
            youtube_music_video_task_item['youtube_music_video_url'] = youtube_music_artist_plate_data_item[
                'youtube_music_video_url']
            youtube_music_video_task_item['youtube_music_source_remark'] = youtube_music_artist_plate_data_item[
                'youtube_music_plate_remark']
            youtube_music_video_task_item['youtube_music_source_playlist_url'] = youtube_music_artist_plate_data_item[
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="CrawlPageVideosSpider爬虫")
    ...
    # 通过命令行启动
    # python crawl_youtube_page_videos_spider.py --start_master  # 添加任务
    # python crawl_youtube_page_videos_spider.py --start_worker  # 启动爬虫
