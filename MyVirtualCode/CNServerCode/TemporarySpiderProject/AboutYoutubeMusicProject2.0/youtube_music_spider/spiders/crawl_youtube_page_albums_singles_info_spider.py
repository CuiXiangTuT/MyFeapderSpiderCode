...
class CrawlYoutubePageAlbumsSinglesInfoSpider(feapder.BatchSpider):
    ...
    def start_requests(self, task):
        ...
        yield feapder.Request(
            url=task_youtube_music_playlist_url,
            render=True,
            task_id=task_id,
    ...
    def parse(self, request, response):
        ...
        for i in playlist_list:
            ...
            youtube_music_playlist_data_item["title"] = title
            youtube_music_playlist_data_item['youtube_music_playlist_url_pre_redirect'] = pre_redirect_url
            ...
            youtube_music_plate_url_task_item['gmg_artist_id'] = youtube_music_playlist_data_item['gmg_artist_id']
            youtube_music_plate_url_task_item['youtube_music_channel_id'] = youtube_music_playlist_data_item['youtube_music_channel_id']
            youtube_music_plate_url_task_item['youtube_music_playlist_id'] = youtube_music_playlist_data_item['youtube_music_playlist_id']
            youtube_music_plate_url_task_item['youtube_music_playlist_url'] = youtube_music_playlist_data_item['youtube_music_playlist_url']
    ...
    #     youtube_music_playlist_data_item["youtube_music_playlist_id"] = request.task_youtube_music_playlist_id
    #     youtube_music_playlist_data_item['youtube_music_playlist_url'] = request.task_youtube_music_playlist_url
    #     youtube_music_playlist_data_item["title"] = request.title
    #     youtube_music_playlist_data_item['youtube_music_playlist_url_pre_redirect'] = request.pre_redirect_url
    #     youtube_music_playlist_data_item['youtube_music_playlist_url_after_redirect'] = current_url
    #     youtube_music_playlist_data_item["batch"] = self.batch_date
    #     youtube_music_playlist_data_item["youtube_music_plate_remark"] = request.task_youtube_music_plate_remark
    #
