...
class CrawlBoomplayTrackInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if is_exists_banner:
            ...
            # ========================================================================
            # 三、歌手任务表相关字段
            boomplay_artist_info_batch_task_item = BoomplayArtistInfoBatchTaskItem()
            boomplay_artist_info_batch_task_item['boomplay_artist_id'] = boomplay_track_info_batch_data_item['capture_artist_id']
            boomplay_artist_info_batch_task_item['boomplay_artist_name'] = boomplay_track_info_batch_data_item['capture_artist_name']
            yield boomplay_artist_info_batch_task_item
