...
class MyTestAirspider4(feapder.AirSpider):
    ...
    def start_requests(self):
        ...
        task_youtube_music_albums_singles_url = "https://music.youtube.com/playlist?list=RDCLAK5uy_lBiyOUBnKuu8qcfu6fDqp3cmW-5Z56dSk"
    ...
    def parse(self, request, response):
        ...
        for i in playlist_list:
            ...
            item['youtube_music_video_playlist_name'] = None
