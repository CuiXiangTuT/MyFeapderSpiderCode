...
class CrawlBoomplayTrackViewsSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if is_exists_banner:
            # 歌曲播放量相关
            boomplay_track_views_batch_data_item = GmgBoomplayTrackViewsBatchDataItem()
            view = response.xpath(
            ...
            # 歌曲播放量采集情况表相关字段
            boomplay_track_views_crawl_situation_record_batch_data_item = GmgBoomplayTrackViewsCrawlSituationRecordBatchDataItem()
