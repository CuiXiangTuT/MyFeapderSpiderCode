...
ITEM_PIPELINES = [
    ...
    "pipelines.bj_temporary_data_instagram_info_pipeline.BjTemporaryDataInstagramInfoPipeline",
    "pipelines.hk_temporary_data_instagram_info_pipeline.HkTemporaryDataInstagramInfoPipeline"
