...
class BoomplayArtistInfoBatchTaskItem(UpdateItem):
    ...
    __update_key__ = ["artist_id", 'artist_name', 'boomplay_artist_name']

    def __init__(self, *args, **kwargs):
        # self.id = kwargs.get('id')
        self.artist_id = None
        self.artist_name = None  # artist_aka中的字段
        ...
        # self.usable = kwargs.get('usable')  # boomplay_artist_id是否可用（artist_aka表中不存在的数据被认为不可用）
...
class BoomplayArtistInfoBatchDataItem(UpdateItem):
    ...
    __unique_key__ = ['boomplay_artist_id']
    __update_key__ = ['artist_id', 'artist_name', 'crawl_condition_boomplay_artist_id',
    ...
    def __init__(self, *args, **kwargs):
        # self.id = kwargs.get('id')
        self.artist_id = None  # 来源于artist_aka提供
        self.artist_name = None  # 来源于artist_aka提供
        ...
        self.crawl_condition_boomplay_artist_name = None  # 来源于artist_aka提供的歌手名
...
class BoomplayArtistInfoCrawlSituationRecordBatchDataItem(UpdateItem):
    ...
    __update_key__ = ["artist_id", "boomplay_artist_exception_info", "boomplay_artist_id", "boomplay_artist_infomation_remarks",
                      "batch"]
...
class BoomplayArtistSongsAlbumsPlaylistsCountsRecordDataItem(UpdateItem):
    """
    9-Item说明：
    ...
    __table_name__ = "boomplay_artist_songs_albums_playlists_counts_record_data"
    __update_key__ = ['artist_id', 'boomplay_artist_id', 'batch', 'albums_count', 'albums_count_none_info', 'songs_count',
