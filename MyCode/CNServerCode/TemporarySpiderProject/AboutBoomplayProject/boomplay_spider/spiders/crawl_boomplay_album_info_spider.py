...
class CrawlBoomplayAlbumInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if is_exists_banner:
            ...
            # =========================================================================================
            # 专辑信息表
            boomplay_album_info_batch_data_item = BoomplayAlbumInfoBatchDataItem()
            # 1-crawl_album_id
            ...
            if is_exists_inner_banner:
                ...
                for per_track in track_ol_list:
                    ...
                    # 专辑歌曲映射表数据
                    boomplay_album_track_batch_data_item = BoomplayAlbumTrackBatchDataItem()
                ...
                boomplay_album_info_crawl_situation_record_batch_data_item = BoomplayAlbumInfoCrawlSituationRecordBatchDataItem()
