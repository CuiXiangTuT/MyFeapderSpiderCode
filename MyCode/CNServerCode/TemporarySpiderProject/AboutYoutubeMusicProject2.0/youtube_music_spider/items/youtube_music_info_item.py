...
class YoutubeMusicChannelIdBatchDataNewItem(UpdateItem):
    """
        1-A.说明：
        任务表：youtube_music_channel_id_batch_task
        目标表：youtube_music_channel_id_batch_data
    ...
    __table_name__ = "youtube_music_channel_id_batch_data_new"
    __update_key__ = [
        "batch", "gmg_artist_id", "gmg_artist_name", "origin_youtube_music_artist_subscriber_count",
        "origin_views", "views", "youtube_music_all_albums_id",
        "youtube_music_all_albums_url", "youtube_music_all_singles_id", "youtube_music_all_singles_url",
        "youtube_music_all_songs_id", "youtube_music_all_songs_url",
        "youtube_music_all_videos_id", "youtube_music_all_videos_url", "youtube_music_artist_about_description",
        "youtube_music_artist_background_image_url", "youtube_music_subscribe_artist_channel_id",
        "youtube_music_artist_description",
        "youtube_music_artist_name", "youtube_music_artist_subscriber_count", "youtube_music_channel_id",
        "youtube_music_channel_name"
    ]
    __unique_key__ = ["youtube_music_channel_id", "batch", "gmg_artist_id"]
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.gtime = kwargs.get('gtime')
        # self.id = kwargs.get('id')
        self.origin_views = None
        self.views = None  # 歌手被查看次数
        # self.youtube_music_all_albums_singles_id = None
        # self.youtube_music_all_albums_singles_url = None
        self.youtube_music_all_albums_id = None
        self.youtube_music_all_albums_url = None
        self.youtube_music_all_singles_id = None
        self.youtube_music_all_singles_url = None
        self.youtube_music_all_songs_id = None
        self.youtube_music_all_songs_url = None
        self.youtube_music_all_videos_id = None
        self.youtube_music_all_videos_url = None
        self.youtube_music_artist_about_description = None
        self.youtube_music_artist_background_image_url = None
        self.youtube_music_subscribe_artist_channel_id = None
        self.youtube_music_artist_description = None
        self.youtube_music_artist_name = None
        self.youtube_music_artist_subscriber_count = None
        self.youtube_music_channel_id = None
        self.youtube_music_channel_name = None
        self.origin_youtube_music_artist_subscriber_count = None
...
class YoutubeMusicArtistPagePlateInfoBatchDataItem(UpdateItem):
    ...
    __unique_key__ = ["gmg_artist_id", "youtube_music_channel_id", "youtube_music_all_songs_id",
                      "youtube_music_all_albums_id", "youtube_music_all_videos_id",
                      "youtube_music_all_songs_url", "youtube_music_all_albums_url",
                      "youtube_music_all_videos_url", "youtube_music_all_singles_id", "youtube_music_all_singles_url"]
    __update_key__ = ["gmg_artist_id", "youtube_music_channel_id", "youtube_music_all_songs_id",
                      "youtube_music_all_albums_id", "youtube_music_all_singles_id", "youtube_music_all_videos_id"]
...
class YoutubeMusicArtistFansAlsoLikeBatchDataItem(UpdateItem):
    ...
    __update_key__ = ["gmg_artist_id", "gmg_artist_name", "youtube_music_channel_id", "youtube_music_channel_name",
                      ...
                      "fans_also_like_artist_channel_url", "fans_also_like_artist_img_url",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fans_also_like_artist_img_url = None
...
class YoutubeMusicPlaylistDataItem(UpdateItem):
    ...
    __update_key__ = ["gmg_artist_id", "youtube_music_channel_id", "youtube_music_playlist_id",
                      ...
                      "batch", "title", "youtube_music_albums_singles_playlist_url", "playlist_type",
                      "publish_date", "img_url"
                      ]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title = None
        self.youtube_music_plate_remark = None
        self.youtube_music_albums_singles_playlist_url = None
...
class YoutubeMusicRelatedPlaylistsInfoBatchDataItem(UpdateItem):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.img_url = None
        self.title = None
        self.youtube_music_related_playlist_id = None
        self.youtube_music_related_playlist_url = None
        self.playlist_type = None
        self.youtube_music_related_playlist_artist_name = None
        self.youtube_music_related_playlist_artist_channel_id = None
        self.youtube_music_related_playlist_artist_channel_url = None
        self.origin_views = None
        self.views = None
        self.batch = None
        # self.gtime = kwargs.get('gtime')
...
class YoutubeMusicArtistPlateDataNewItem(UpdateItem):
    """
    24-用来存储playlist产生的数据，包含Albums/Singles、Songs、Videos
    """

    __table_name__ = "youtube_music_artist_plate_data_new"
    __update_key__ = ['gmg_artist_id', 'youtube_music_channel_id', 'youtube_music_playlist_id',
                      'youtube_music_playlist_url', 'youtube_music_plate_remark', 'serial_number',
                      'title', 'playlist_type', 'artist_name', 'publish_date',
                      'artist_channel_id', 'img_url', 'origin_songs_count', 'songs_count',
...
class YoutubeMusicArtistPlaylistMapItem(UpdateItem):
    """
    25-用来存放歌手、【专辑、单曲】之间的映射关系
    """

    __table_name__ = "youtube_music_artist_playlist_map"
    __update_key__ = ["gmg_artist_id", "youtube_music_channel_id", "youtube_music_channel_id_other",
                       "youtube_music_plate_remark","youtube_music_playlist_id",
                      "youtube_music_playlist_id_other",
                      "youtube_music_playlist_url", "youtube_music_playlist_url_other"
                      ]
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.id = kwargs.get('id')
        self.youtube_music_channel_id = None
        self.youtube_music_channel_id_other = None
        self.youtube_music_plate_remark = None
        self.youtube_music_playlist_id = None
        self.youtube_music_playlist_id_other = None
        self.youtube_music_playlist_url = None
        self.youtube_music_playlist_url_other = None
