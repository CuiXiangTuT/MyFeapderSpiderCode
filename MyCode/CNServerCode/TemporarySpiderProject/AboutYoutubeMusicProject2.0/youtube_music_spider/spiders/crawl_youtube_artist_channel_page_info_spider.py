    ...
    def parse(self, request, response):
        ...
        if len(matches) >= 2:
            ...
            if match:
                ...
                # 6-歌手被查看次数
                youtube_music_channel_id_batch_data_item["origin_views"] = json_data["contents"]["singleColumnBrowseResultsRenderer"]["tabs"][0]["tabRenderer"]["content"]["sectionListRenderer"]["contents"][-1]["musicDescriptionShelfRenderer"]["subheader"]["runs"][0]["text"] if "musicDescriptionShelfRenderer" in str(json_data["contents"]["singleColumnBrowseResultsRenderer"]["tabs"][0]["tabRenderer"]["content"]["sectionListRenderer"]["contents"]) else 0
                youtube_music_channel_id_batch_data_item['views'] = str(youtube_music_channel_id_batch_data_item["origin_views"]).replace(" views","").replace(' view',"").replace(",","")
                # 7-歌手所有歌曲的URL
                if "musicShelfRenderer" in str(json_data["contents"]["singleColumnBrowseResultsRenderer"]["tabs"][0]["tabRenderer"]["content"]["sectionListRenderer"]["contents"][0]) and "browseEndpoint" in str(json_data["contents"]["singleColumnBrowseResultsRenderer"]["tabs"][0]["tabRenderer"]["content"]["sectionListRenderer"]["contents"][0]["musicShelfRenderer"]["title"]["runs"][0]):
                    ...
                    youtube_music_artist_plate_task_item["youtube_music_playlist_id"] = youtube_music_channel_id_batch_data_item["youtube_music_all_songs_id"][2:]
                    youtube_music_artist_plate_task_item["youtube_music_playlist_url"] = "https://music.youtube.com/playlist?list="+youtube_music_channel_id_batch_data_item["youtube_music_all_songs_id"]
                        ...
                        for per_songs in json_songs_data:
                            ...
                            for per_flex in per_songs["musicResponsiveListItemRenderer"]["flexColumns"]:
                                if "MUSIC_VIDEO_TYPE_ATV" in str(per_flex):
                                    ...
                                    youtube_music_artist_page_songs_batch_data_item["views"] = int(float(flex_views.lower().replace("k",""))*1000) if "k" in flex_views.lower() else int(float(flex_views.lower().replace('m',""))*1000000) if "m" in flex_views.lower() else int(float(flex_views.lower().replace("b",""))*1000000000) if "b" in flex_views.lower() else int(flex_views)
                ...
                for k in musicCarouselShelfRenderer_data_list:
                    ...
                    if key_label=="Albums":
                        ...
                        youtube_music_playlist_task_item["gmg_artist_id"] = request.task_gmg_artist_id
                        youtube_music_playlist_task_item['youtube_music_plate_remark'] = "Albums/Singles"
                        youtube_music_playlist_task_item["youtube_music_channel_id"] = request.task_youtube_music_channel_id
                        youtube_music_playlist_task_item["youtube_music_playlist_id"] = youtube_music_channel_id_batch_data_item["youtube_music_all_albums_singles_id"]
                        youtube_music_playlist_task_item["youtube_music_playlist_url"] = youtube_music_channel_id_batch_data_item["youtube_music_all_albums_singles_url"]
                        ...
                        youtube_music_artist_plate_task_item["gmg_artist_id"] = request.task_gmg_artist_id
                        youtube_music_artist_plate_task_item["youtube_music_channel_id"] = request.task_youtube_music_channel_id
                        youtube_music_artist_plate_task_item["youtube_music_playlist_id"] = youtube_music_channel_id_batch_data_item["youtube_music_all_videos_id"]
                        youtube_music_artist_plate_task_item["youtube_music_playlist_url"] = youtube_music_channel_id_batch_data_item["youtube_music_all_videos_url"]
                        ...
                        for featured_per in featured_list:
                            ...
                            youtube_music_artist_page_featured_batch_data_item["featured_id"] = featured_per["musicTwoRowItemRenderer"]["title"]["runs"][0]["navigationEndpoint"]["browseEndpoint"]["browseId"][2:]
                            ...
                            youtube_music_artist_plate_task_item["gmg_artist_id"] = request.task_gmg_artist_id
                            youtube_music_artist_plate_task_item["youtube_music_channel_id"] = request.task_youtube_music_channel_id
                            youtube_music_artist_plate_task_item["youtube_music_playlist_id"] = youtube_music_artist_page_featured_batch_data_item["featured_id"]
                            youtube_music_artist_plate_task_item["youtube_music_playlist_url"] = youtube_music_artist_page_featured_batch_data_item["featured_url"]
                        ...
                        for fans_also_like_per in fans_also_like_list:
                            ...
                            if fans_also_like_per["musicTwoRowItemRenderer"].get("subtitle"):
                                ...
                                youtube_music_artist_fans_also_like_batch_data_item["origin_fans_also_like_artist_subscriber_count"] = None
                                youtube_music_artist_fans_also_like_batch_data_item["fans_also_like_artist_subscriber_count"] = 0
