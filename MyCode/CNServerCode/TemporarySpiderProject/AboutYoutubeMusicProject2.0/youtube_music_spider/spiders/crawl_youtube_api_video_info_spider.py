...
class CrawlYoutubeApiVideoInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        for per_json in json_data_list:
            ...
            if per_json.get("snippet") and per_json["snippet"].get("tags"):
            ...
            if per_json.get("topicDetails") and per_json["topicDetails"].get("topicCategories"):
