...
class GmgBoomplayArtistInfoBatchTaskItem(UpdateItem):
    """
    2-Item说明：
        Item：歌手任务相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_artist_info_batch_task"
...
class GmgBoomplayAlbumInfoBatchTaskItem(UpdateItem):
    """
    3-Item说明：
        Item：专辑任务相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_album_info_batch_task"
...
class GmgBoomplayTrackInfoBatchTaskItem(UpdateItem):
    """
    4-Item说明：
        Item：歌曲任务相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_track_info_batch_task"
...
class GmgBoomplayArtistTrackBatchDataItem(UpdateItem):
    """
    5-Item说明：
        Item：歌手-歌曲 映射相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_artist_track_batch_data"
...
class GmgBoomplayArtistInfoBatchDataItem(UpdateItem):
    """
    7-Item说明：
        Item：歌手个人信息相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_artist_info_batch_data"
    __unique_key__ = ['boomplay_artist_id']
...
class GmgBoomplayArtistInfoCrawlSituationRecordBatchDataItem(UpdateItem):
    """
    8-Item说明：
        ...
        涉及程序：
            crawl_boomplay_artist_info_spider.py
    """
    __table_name__ = "b_gmg_boomplay_artist_info_crawl_situation_record_batch_data"
    __update_key__ = ["gmg_artist_id", "boomplay_artist_exception_info", "boomplay_artist_id", "boomplay_artist_infomation_remarks",
                      "batch"]
...
class GmgBoomplayArtistSongsAlbumsPlaylistsCountsRecordDataItem(UpdateItem):
    """
    9-Item说明：
    ...
    __table_name__ = "b_gmg_boomplay_artist_songs_albums_playlists_counts_record_data"
    __update_key__ = ['gmg_artist_id', 'boomplay_artist_id', 'batch', 'albums_count', 'albums_count_none_info', 'songs_count',
...
class GmgBoomplayArtistPlaylistBatchDataItem(UpdateItem):
    """
    10-Item说明：
        Item：歌手 播放列表映射 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_artist_playlist_batch_data"
...
class GmgBoomplayPlaylistInfoBatchTaskItem(UpdateItem):
    """
    11-Item说明：
        Item：播放列表任务 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_playlist_info_batch_task"
...
class GmgBoomplayArtistAlbumBatchDataItem(UpdateItem):
    """
    12-Item说明：
        Item：歌手-专辑任务 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_artist_album_batch_data"
...
class GmgBoomplayAlbumInfoCrawlSituationRecordBatchDataItem(UpdateItem):
    """
    13-Item说明：
        Item：专辑任务采集情况 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_album_info_crawl_situation_record_batch_data"
...
class GmgBoomplayAlbumInfoBatchDataItem(UpdateItem):
    """
    14-Item说明：
        Item：专辑详情 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_album_info_batch_data"
...
class GmgBoomplayAlbumTrackBatchDataItem(UpdateItem):
    """
    15-Item说明：
        Item：专辑歌曲映射 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_album_track_batch_data"
...
class GmgBoomplayTrackInfoCrawlSituationRecordBatchDataItem(UpdateItem):
    """
    16-Item说明：
    ...
    __table_name__ = "b_gmg_boomplay_track_info_crawl_situation_record_batch_data"
...
class GmgBoomplayTrackInfoBatchDataItem(UpdateItem):
    """
    17-Item说明：
    ...
    __table_name__ = "b_gmg_boomplay_track_info_batch_data"
    ...
    __update_key__ = ["track_id", "crawl_result_track_id", "track_name", "crawl_condition_track_id",
                      ...
                      "capture_artist_id", "capture_artist_name", "capture_artist_image", "capture_album_id","capture_album_name",
                      "capture_album_image","track_favorite_count","track_share_count","track_comment_count","genre",
                      "publish_date","fix_publish_date","lyrics_url","lyrics",
                      "batch"]
...
class GmgBoomplayTrackNameCleanedDataItem(UpdateItem):
    """
    18-Item说明：
        Item：歌曲信息采集情况信息 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_track_name_cleaned_data"
...
class GmgBoomplayTrackViewsBatchDataItem(UpdateItem):
    """
    19-Item说明：
    ...
    __table_name__ = "b_gmg_boomplay_track_views_batch_data"
    __unique_key__ = ['track_id', 'batch']
...
class GmgBoomplayTrackViewsCrawlSituationRecordBatchDataItem(UpdateItem):
    """
    20-Item说明：
        Item：歌曲信息采集情况信息 相关字段
        IP：192.168.10.135
    ...
    __table_name__ = "b_gmg_boomplay_track_views_crawl_situation_record_batch_data"
