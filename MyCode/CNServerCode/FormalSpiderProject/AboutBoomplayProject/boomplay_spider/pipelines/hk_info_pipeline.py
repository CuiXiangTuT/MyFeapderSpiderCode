...
class HkInfoPipeline(BasePipeline):

    def __init__(self) -> None:
        # 链接数据库
        self._db = MysqlDB(ip=HK_SERVER_MYSQL_IP,
                           port=HK_SERVER_MYSQL_PORT,
                           user_name=HK_SERVER_MYSQL_USER_NAME,
                           user_pass=HK_SERVER_MYSQL_USER_PASS,
                           db=HK_SERVER_MYSQL_DB)
