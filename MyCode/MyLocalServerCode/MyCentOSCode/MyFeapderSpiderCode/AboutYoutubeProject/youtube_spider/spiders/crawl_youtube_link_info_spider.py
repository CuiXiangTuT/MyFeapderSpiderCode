...
class CrawlYoutubeLinkInfoSpider(feapder.BatchSpider):
    ...
    def add_task(self):
        update_state_sql = "UPDATE {} SET {} = 0 WHERE {} = -1".format(self._task_table,self._task_state,
                                                                                             self._task_state)
        # update_state_sql = "UPDATE youtube_video_batch_task SET {} = 0".format(self._task_state)
