...
class CrawlBoomplayTrackInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if is_exists_banner:
            ...
            # ========================================================================
            # 一、歌曲信息相关字段
            boomplay_track_info_batch_data_item = GmgBoomplayTrackInfoBatchDataItem()
            # 1-歌曲id
            ...
            # ========================================================================
            # 二、歌曲名清理表相关字段
            boomplay_track_name_cleaned_data_item = GmgBoomplayTrackNameCleanedDataItem()
            ...
            # 三、歌曲采集情况相关字段
            boomplay_track_info_crawl_situation_record_batch_data_item = GmgBoomplayTrackInfoCrawlSituationRecordBatchDataItem()
