...
class BoomplayTrackInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if response.xpath('//div[@class="noData"]/div[@class="text"]'):
            ...
            artist_name_get = ''.join(response.xpath('.//a[@class="ownerWrap"]/strong/text()').extract()).strip()
            ...
            try:
                ...
                track_info_batch_data_item["capture_album_name"] = album_name_get.split(":")[1].replace("&amp;","&").replace("&#039;","'") if "album" in album_name_get else album_name_get
            except:
