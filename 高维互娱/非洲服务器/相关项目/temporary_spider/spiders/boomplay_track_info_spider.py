...
class BoomplayTrackInfoSpider(feapder.BatchSpider):
    ...
    def parse(self, request, response):
        ...
        if response.xpath('//div[@class="noData"]/div[@class="text"]'):
            ...
            track_info_batch_data_item["capture_artist_name"] = str(artist_name_get.split(":")[1]).strip().replace("&amp;","&").replace("&#039;","'").lower() if "Artist" in artist_name_get else artist_name_get.lower()
            # 11-歌手id
